...
| ----------- | ----------- | ----------- | ----------- |
| ***COVID-19 patients in Intensive Care Units (ICU)*** ![default_pred_app](images/projects/virus.png) <small><small>*Image courtesy: ndr.de*</small> | *To implement a prediction app for COVID-19 patients in ICU* | *In my free time I implemented a time-series regression model on public covid datasets provided by www.ourworldindata.org to predict the number of COVID-19 patients in ICU for different countries. I deployed the app in the streamlit community cloud (https://sebastian1981-covid-prediction-streamlit-appapp-i8x7ho.streamlitapp.com). The code and more details are provided in my github repo: "covid_prediction")* | *Machine Learning, Data Preparation, Data Visualization, Auto-ML, Python (numpy, pandas, matplotlib, pycaret, streamlit), Jupyter, VSCode* |
| **Use Case** | **Project Goal** | **Implementation** | **Skills & Tools** |
