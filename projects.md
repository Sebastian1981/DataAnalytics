...
In the following, I provide an overview of the relevant the data science projects I conducted throughout the years. They will be subdivided into the major categories such as industry related projects, research related projects or personal interest projects. Technically, the projects will be sub-categorized into five major groups such as regression, classification, clustering, image analysis and natural language processing. Further, for each project it is stated whether it was a proof-of-concept study only or also with deployment. Note that e.g. classification and clustering are very similar methods in terms of the outcomes, differing only in whether the training data was labeled (supervised learning) or not (unsupervised learning). Therefore, both groups may sometimes overlap within in a single project (see e.g. the "entity resolution project").
