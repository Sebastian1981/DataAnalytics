...
| Use Case | Goal | my Role | Skills & Tools |
| ----------- | ----------- | ----------- | ----------- |
...
| Use Case | Goal | my Role | Skills & Tools |
| ----------- | ----------- | ----------- | ----------- |
| **Completion Rate Model** ![abschlussquoten_optimierung](images/projects/abschlussquoten_optimierung.png)| Maximizing the likelihood of business deals | *I developed a classification model (supervised machine learning) providing the propensity scores of business deals based on labeled historical datasets. I further prepared the data, visualized the data and evaluated and optimized the model performance. I also supported the specialist department in an advisory capacity in evaluating the benefit of the model in the event of potential productive use.* | Machine Learning, Data Preparation, Data Visualization, Python (numpy, pandas, matplotlib, sklearn), Jupter Notebook |

| Use Case | Goal | my Role | Skills & Tools |
| ----------- | ----------- | ----------- | ----------- |
| **Pricing Model** ![abschlussquoten_optimierung](images/projects/abschlussquoten_optimierung.png)| Find the optimal product price | *I developed a classification-regression mixture model (supervised machine learning) to find the optimal product prices based on labeled historical datasets. I further prepared the data, visualized the data and evaluated and optimized the model performance. I also supported the specialist department in an advisory capacity in evaluating the benefit of the model in the event of potential productive use and how to iteratively improve the model in the long run.* | Machine Learning, Data Preparation, Data Visualization, Python (numpy, pandas, matplotlib, sklearn, spacy), Jupter Notebook, SPSS modeler |
